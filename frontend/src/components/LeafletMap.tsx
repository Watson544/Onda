...
export default function LeafletMap({ venues }: LeafletMapProps) {
  const mapRef = useRef<LeafletMap | null>(null);

  // On unmount, destroy the Leaflet instance so the container's _leaflet_id
  // is cleared before React ever re-mounts this component.
  useEffect(() => {
    return () => {
      if (mapRef.current) {
